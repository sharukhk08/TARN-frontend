...
export const BASE_API_URL = `${LOCAL_API_URL}api/v1`;
...
export const ADD_QUIZ_SCORE_API = `${BASE_API_URL}/add/quiz`;
export const LIST_QUIZ_SCORE_API = `${BASE_API_URL}/list/quiz`;
